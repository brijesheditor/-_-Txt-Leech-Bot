...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(
       "Hii Dear ❤️ 
       I Am A Bot For Download Links From Your **.TXT** File And Then Upload That File On Telegram So Basically If You Want To Use Me First Send Me ⟰ /𝐁𝐑𝐈𝐉𝐄𝐒𝐇 Command And Then Follow Few Steps..", reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("✜ 𝐉𝐨𝐢𝐧 𝐔𝐩𝐃𝐚𝐭𝐞 Group 🥱✜" ,url=f"https://t.me/+qutXY5xbN0I4OWY1") ],
                    [
                    InlineKeyboardButton("✜ 𝐁𝐑𝐈𝐉𝐄𝐒𝐇 ✜" ,url="t.me/Oye_brijesh") ],
                    [
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                    ...
                    Show = f"❊⟱ 𝐃𝐨𝐰𝐧𝐥𝐨𝐚𝐝𝐢𝐧𝐠 ⟱❊ »\n\n📄 Title:- `{name}\n\n⌨ 𝐐𝐮𝐥𝐢𝐭𝐲 » {raw_text2}`\n\n**🔗 𝐔𝐑𝐋 »** `{url}`"kya 🤔 karega url dekh kar 🤣
